...
function MainMenuTitle:init(menu)
  ...
  --  self.logo = Assets.getTexture("kristal/title_logo") -- removed kristal version. dont need since front already has it
    self.front = Assets.getTexture("kristal/title_front")
