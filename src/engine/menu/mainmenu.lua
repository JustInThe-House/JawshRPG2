...
function MainMenu:init()
    self.scroll = Assets.getTexture("kristal/title_scroll")
    self.bg = Assets.getTexture("kristal/title_bg")
    self.timer_scroll = 0
end
...
function MainMenu:draw()
    ...
    self:drawVersion()
self.timer_scroll = self.timer_scroll + 5*DTMULT
    Draw.draw(self.bg, 0,0)
    Draw.drawWrapped(self.scroll, true, true, -self.timer_scroll,0.75*self.timer_scroll)
