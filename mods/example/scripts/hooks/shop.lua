...
function Shop:draw()
    ...
    if self.state == "MAINMENU" then
        ...
        Draw.draw(self.heart_sprite, 450, 230 + (self.main_current_selecting * 40),0,0.25,0.25)
    elseif self.state == "BUYMENU" then
        ...
        if not self.buy_confirming then
            Draw.draw(self.heart_sprite, 30, 230 + ((self.current_selecting - self.item_offset) * 40),0,0.25,0.25)
        else
            Draw.draw(self.heart_sprite, 30 + 420, 230 + 80 + 10 + (self.current_selecting_choice * 30),0,0.25,0.25)
            Draw.setColor(COLORS.white)
    ...
    elseif self.state == "SELLMENU" then
        Draw.setColor(Game:getSoulColor())
        Draw.draw(self.heart_sprite, 50, 230 + (self.sell_current_selecting * 40),0,0.25,0.25)
        Draw.setColor(COLORS.white)
        love.graphics.setFont(self.font)
    ...
    elseif self.state == "SELLING" then
        ...
        Draw.draw(self.heart_sprite, 30, 230 + ((self.item_current_selecting - self.item_offset) * 40),0,0.25,0.25)
    ...
    elseif self.state == "TALKMENU" then
        Draw.setColor(Game:getSoulColor())
        Draw.draw(self.heart_sprite, 50, 230 + (self.current_selecting * 40),0,0.25,0.25)
        Draw.setColor(COLORS.white)
        love.graphics.setFont(self.font)
