...
<tileset version="1.11" tiledversion="1.11.2" name="minecraft_portal" tilewidth="40" tileheight="40" tilecount="32" columns="1">
 <editorsettings>
  <export target="minecraft_portal.lua" format="lua"/>
 </editorsettings>
 <image source="../../../assets/sprites/tilesets/nether_portal.png" width="40" height="1280"/>
 <tile id="0">
  <animation>
